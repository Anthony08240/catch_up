...
<div class="entity_wrapper">
    ...
    <div class="entity_title">
        <a href="single.php" target="_blank"><h3> Airbnb launches photo-centric app for iPads and Android
            tablets. </h3></a>
    </div>
    <!-- entity_title -->
...
<div class="widget reviews m30">
    ...
    <div class="media">
        ...
        <div class="media-body"><h3 class="media-heading"><a href="single.php" target="_blank">Samsung is the best
...
<section id="footer_section" class="footer_section">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="footer_widget_title"><h3><a href="category.php" target="_blank">About Tech</a></h3></div>
