                        ...
                        <div class="col-md-8">
                            <div class="entity_wrapper">
                                ...
                                <div class="entity_content">
                                    ...
                                    after installed base benefits. Dramatically visualize customer directed convergence
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="category_article_body">
                                        ...
                                        <div class="category_article_title">
                                            <h5><a href="single.php" target="_blank">Airbnb launches photo-centric app
                                ...
                                <div class="col-md-6">
                                    <div class="category_article_body">
                                        <div class="top_article_img">
                                            <img class="img-responsive" src="assets/img/category_img2.jpg"
                                                alt="feature-top">
                                        </div>
                                        <!-- top_article_img -->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="category_article_body">
                                        <div class="top_article_img">
                                            <img class="img-responsive" src="assets/img/category_img3.jpg"
                                                alt="feature-top">
                                        </div>
                                        <!-- row -->
                                ...
                                <div class="col-md-6">
                                    <div class="category_article_body">
                                        <div class="top_article_img">
                                            <img class="img-responsive" src="assets/img/category_img4.jpg"
                                                alt="feature-top">
                                        </div>
                                        <!-- top_article_img -->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="category_article_body">
                                        <div class="top_article_img">
                                            <img class="img-responsive" src="assets/img/category_img5.jpg"
                                                alt="feature-top">
                                        </div>
                                        <!-- top_article_img -->
                                ...
                                <div class="col-md-6">
                                    <div class="category_article_body">
                                        <div class="top_article_img">
                                            <img class="img-responsive" src="assets/img/category_img6.jpg"
                                                alt="feature-top">
                                        </div>
                                        <!-- top_article_img -->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="category_article_body">
                                        <div class="top_article_img">
                                            <img class="img-responsive" src="assets/img/category_img7.jpg"
                                                alt="feature-top">
                                        </div>
                                        <!-- top_article_img -->
                                ...
                                <div class="col-md-6">
                                    <div class="category_article_body">
                                        <div class="top_article_img">
                                            <img class="img-responsive" src="assets/img/category_img8.jpg"
                                                alt="feature-top">
                                        </div>
                                        <!-- top_article_img -->
                        ...
                        <div class="col-md-4">
                            <div class="widget">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h3 class="media-heading">
                                            <a href="single.php" target="_blank">Canon launches photo centric 00214
                                        ...
                                        <div class="widget_article_social">
                                            <span>
                                                <a href="single.php" target="_blank"> <i
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h3 class="media-heading">
                                            <a href="single.php" target="_blank">Samsung galaxy note are the supper
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h3 class="media-heading">
                                            <a href="single.php" target="_blank">Apple launches photo-centric wrist
                                                watch for Android</a>
                                        </h3>
                                        <span class="media-date"><a href="#">10Aug- 2015</a>, by: <a href="#">Eric
                                                joan</a></span>
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h3 class="media-heading">
                                            <a href="single.php" target="_blank">Kodak Hi-Speed shutter double shot
                            ...
                            <div class="widget reviews m30">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h3 class="media-heading">
                                            <a href="single.php" target="_blank">DSLR is the most old camera at this
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h3 class="media-heading"><a href="single.php" target="_blank">Samsung is the
                                                best
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h3 class="media-heading">
                                            <a href="single.php" target="_blank">Yasaki camera launches new generic
                            ...
                            <div class="widget m30">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h3 class="media-heading">
                                            <a href="single.php" target="_blank">Samsung is the best mobile in the
                                                android market.</a>
                                        </h3>
                                ...
                                <p class="widget_divider"><a href="#" target="_blank">More News&nbsp;&nbsp;&raquo; </a>
                                </p>
                            </div>
                            <!-- Most Commented News -->
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="footer_widget_title">
                                    <h3><a href="category.php" target="_blank">About Tech</a></h3>
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="footer_widget_title">
                                    <h3><a href="category.php" target="_blank">Discover</a></h3>
                                </div>
                                <div class="row">
                                    <div class="col-xs-4">
                            ...
                            <div class="col-md-3">
                                <div class="footer_widget_title">
                                    <h3><a href="category.php" target="_blank">Tech Photos</a></h3>
                                </div>
